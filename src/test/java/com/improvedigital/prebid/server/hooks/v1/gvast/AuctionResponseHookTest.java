...
public class AuctionResponseHookTest extends UnitTestBase {
    ...
    @Test
    public void shouldNotModifyBidResponseWhenNoImpOfNonVastVideoIsPresentInRequest() {
        GVastHooksModuleContext moduleContext = getModuleContext(bidRequest -> {
    ...
    public void testCode() {
        ...
        assertThat(result).isEqualTo("improvedigital-gvast-hooks-auction-response");
    }
    ...
    private GVastHooksModuleContext getModuleContext() {
        return getModuleContext(null);
    }

    private GVastHooksModuleContext getModuleContext(Function<BidRequest, BidRequest> requestModifier) {
        BidRequest bidRequest = getBidRequest(requestModifier);
        return gVastHookUtils.createModuleContext(bidRequest);
    }
